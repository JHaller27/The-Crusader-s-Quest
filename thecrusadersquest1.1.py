...
def char_menu():
    ...
    print('Weapon: ' + ctx.weapon + '')
    print('######################')
    print('Consumption Rate: ' + str(ctx.consumption_rate) + '')
    print('Food: ' + str(ctx.food) + '/' + str(ctx.max_food) + '')
    print('Endurance: ' + str(ctx.endurance) + '')
    print('Arrows: ' + str(ctx.arrows) + '/' + str(ctx.max_arrows) + '')
    print('######################')
    # print('Luck: ' + str(ctx.luck) + '')
    # print('Speed: ' + str(ctx.speed) + '\n')
